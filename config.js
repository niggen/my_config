module.exports = {
	...
	adminId: "949832278987636766", //- Replace UserId with the Discord ID of the admin of the bot
	token: process.env.token || "MTAxMjc5ODU2NTc1Nzc2Nzc5MA.Gk985C.FT7pCXwxBscsm6UsnMrD9noI_d5thuwKc28RGg", //- Bot's Token
	clientId: process.env.clientId || "1012798565757767790", //- ID of the bot
	clientSecret: process.env.clientSecret || "sUvNdCES3zRUxhsZIVgzQuBXi-_y0zeN", //- Client Secret of the bot
	...
	nodes: [
		{
			...
			password: "Cuubietsualon", //- The password of the lavalink server.
